      ...
      <ul>
          ...
          <ul class="mega-menu">
            <li>
              <a class="d-block img-thumbnail text-center navi-link" href="index.html">
                <img alt="Featured Products Slider" src="~/assets/img/mega-menu-home/01.jpg">
            ...
            <li>
              <a class="d-block img-thumbnail text-center navi-link" href="home-featured-categories.html">
                <img alt="Featured Categories" src="~/assets/img/mega-menu-home/02.jpg">
            ...
            <li>
              <a class="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.html">
                <img alt="Products Collection Showcase" src="~/assets/img/mega-menu-home/03.jpg">
                <h6 class="mt-3">Products Collection Showcase</h6>
              </a>
            </li>
            <li>
              <a class="d-block img-thumbnail text-center navi-link" href="home-dark-header.html">
                <img alt="Dark Header" src="~/assets/img/mega-menu-home/04.jpg">
                <h6 class="mt-3">Dark Header</h6>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="has-megamenu">
          ...
          <ul class="mega-menu">
            ...
            <li>
              ...
              <ul class="sub-menu">
                <li>
                  <a href="#">Junior's Shop</a>
                </li>
                <li>
                  <a href="#">Swim Shop</a>
                </li>
                <li>
                  <a href="#">Athletic Shop</a>
                </li>
                <li>
        ...
        <li>
          ...
          <ul class="sub-menu">
            ...
            <li>
              <a class="text-danger" href="docs/dev-setup.html">Documentation</a>
            </li>
          </ul>
        </li>
        <li class="has-megamenu">
          ...
          <ul class="mega-menu">
            ...
            <li>
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="components/market-social-buttons.html">Market &amp; Social Buttons</a>
                </li>
                <li>
            ...
            <li>
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="components/tooltips-popovers.html">Tooltips &amp; Popovers</a>
                </li>
                <li>
